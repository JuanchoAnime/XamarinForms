...
{
    public class AgoraVideoViewRenderer : Xamarin.Forms.Platform.Android.ViewRenderer
    {
        ...
        protected override void OnElementChanged(global::Xamarin.Forms.Platform.Android.ElementChangedEventArgs<View> e)
        {
            ...
            global::Android.App.Application.SynchronizationContext.Post(_ =>
            {
                ...
                _videoService = AgoraService.Current as AgoraServiceImplementation;
