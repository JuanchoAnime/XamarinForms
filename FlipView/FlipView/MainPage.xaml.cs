...
namespace FlipView
{
    ...
    {
        public ObservableCollection<Explorer> Places => GetExplorer();
        ...
        private async void FilToBack(object sender, EventArgs e)
        {
        ...
        private async void FilToFront(object sender, EventArgs e)
        {
            var front = sender as Grid;
            var back = front.Parent.FindByName<Grid>("FrontView");
            await Flip(front, back);
        }
        ...
        private async Task Flip(VisualElement from, VisualElement to) 
        {
            ...
            to.RotationY = 90;to.IsVisible = true;
            from.IsVisible = false;
            await to.RotateYTo(0, 250, Easing.SpringOut);
        }

        private ObservableCollection<Explorer> GetExplorer()
        {
            return new ObservableCollection<Explorer>
            {
                new Explorer
                {
                    Name = "Costa Rica",
